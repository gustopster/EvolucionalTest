...
describe('ProductFormPage', () => {
    ...
    it('exibe erros para campos inválidos', async () => {
        ...
        await waitFor(() => {
            expect(
                screen.getByText('O nome é obrigatório.')
            ).toBeInTheDocument();
        });
    ...
    it('valida nome com menos de três caracteres', async () => {
        renderPage();
    ...
    it('cria um produto válido', async () => {
        ...
        expect(
            screen.getByText('Produto criado com sucesso.')
        ).toBeInTheDocument();
    });
    ...
    it('carrega dados no modo de edição', async () => {
        ...
        await waitFor(() =>
            expect(screen.getByLabelText('Nome')).toHaveValue('Teclado')
        );
